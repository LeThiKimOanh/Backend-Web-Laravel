...
<link rel="icon" href="/users_template/images/favicon.png" type="image/x-icon">
<title> {{ $title }}</title>
 ...
 <!-- Google Font: Source Sans Pro -->
  ...
  <link rel="stylesheet" href="/admin_template/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
 ...
 <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="/admin_template/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
 <!-- Select2 -->
  ...
  <link rel="stylesheet" href="/admin_template/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="/admin_template/plugins/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="/admin_template/plugins/dropzone/min/dropzone.min.css">
